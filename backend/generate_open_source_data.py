...
from modules.service.sqlite_utils.query import query_country_by_year_with_import_export_data_frame_by_item_group, \
    query_country_by_year_with_import_export_item_group_data_frame, query_political_stability_by_year_data_frame
...
data_config = {
    ...
    'fao_country_by_year_with_import_export_item_group_and_stability_cut_10': {
        'raw_data_file': 'fao_country_by_year_with_import_export_item_group_and_stability_cut_10_raw.bin',
        'normalized_raw_data_file': 'fao_country_by_year_with_import_export_item_group_and_stability_cut_10_normalized_raw.bin',
        'data_file': 'fao_country_by_year_with_import_export_item_group_and_stability_cut_10.bin',
        'base_avg_data_file': 'fao_country_by_year_with_import_export_item_group_and_stability_cut_10_base_avg.bin',
        'pdist_file': 'fao_country_by_year_with_import_export_item_group_and_stability_cut_10_pdsit.bin',
        'clustering_file': 'fao_country_by_year_with_import_export_item_group_and_stability_cut_10_clustering.bin',
    }
}
...
def load_country_by_year_with_import_export_item_group_and_stability_cut_10_data():
    stablity_data = query_political_stability_by_year_data_frame()
    trade_data = query_country_by_year_with_import_export_item_group_data_frame()
    raw_data = pd.concat([trade_data, stablity_data], axis=1)
    normalized_data = get_column_normalized_data(raw_data)
    data = DataFrame()
    for key in normalized_data:
        try:
...
def make_datas():
    ...
    # make country by year with item group and social stability data
    make_data(data_config['fao_country_by_year_with_import_export_item_group_and_stability_cut_10'],
              load_country_by_year_with_import_export_item_group_and_stability_cut_10_data)
